...
class ProductController extends Controller
{
    ...
    // ─── SHOW by ID (pass Eloquent model langsung ke view) ───────────────────
    ...
    public function show($id)
    {
        ...
        // Pass Eloquent model langsung karena product_details.blade.php
        // expect $product->mainImage->image_path (accessor di model)
